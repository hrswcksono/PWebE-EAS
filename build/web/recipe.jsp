<%-- 
    Document   : recipe
    Created on : Nov 28, 2020, 6:05:41 PM
    Author     : USER
--%>
...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into recipe(book_name,author_name,publisher_name,publish_year,description,number_of_page)values(?,?,?,?,?,?)");
                                  ...
                                  Statement st = con.createStatement();
                                   ...
                                   %>
											...
											<tr role="row" class="odd">
													...
													<td>
                                                                                                            <a href="updaterecipe.jsp?id=<%=id%>">Edit</a>
                                                                                                            <a href="deleterecipe.jsp?id=<%=id%>">Delete</a>
