<%-- 
    Document   : updatenewspaper
    Created on : Nov 28, 2020, 8:42:21 PM
    Author     : USER
--%>
...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update newspaper set book_name = ?,author_name =?,publisher_name= ?,publish_year= ?,description= ?,number_of_page= ? where id = ?");
			...
			<div class="content">
				...
				<form  method="POST" action="#" >
                    ...
                    <%    
                        ...
                        pst = con.prepareStatement("select * from newspaper where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    <% }  %>
                     ...
                     <div alight="right">
                         ...
                         <div align="right">
                             ...
                             <p><a href="newspaper.jsp">Click Back</a></p>
