<%-- 
    Document   : updatecomic
    Created on : Nov 28, 2020, 8:21:06 PM
    Author     : USER
--%>
...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update comic set book_name = ?,author_name =?,publisher_name= ?,publish_year= ?,description= ?,number_of_page= ? where id = ?");
        ...
        response.sendRedirect("comic.jsp");
			...
			<div class="content">
				...
				<form  method="POST" action="#" >
                    ...
                    <%    
                        ...
                        pst = con.prepareStatement("select * from comic where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    <% }  %>
                     ...
                     <div alight="right">
                         ...
                         <div align="right">
                             ...
                             <p><a href="comic.jsp">Click Back</a></p>
