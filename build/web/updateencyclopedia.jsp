<%-- 
    Document   : updateencyclopedia
    Created on : Nov 28, 2020, 8:32:05 PM
    Author     : USER
--%>
...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update encyclopedia set book_name = ?,author_name =?,publisher_name= ?,publish_year= ?,description= ?,number_of_page= ? where id = ?");
        ...
        response.sendRedirect("encyclopedia.jsp");
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Encyclopedia</h4>
				...
				<form  method="POST" action="#" >
                    ...
                    <%    
                        ...
                        pst = con.prepareStatement("select * from encyclopedia where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    <% }  %>
                     ...
                     <div alight="right">
                         ...
                         <div align="right">
                             ...
                             <p><a href="encyclopedia.jsp">Click Back</a></p>
