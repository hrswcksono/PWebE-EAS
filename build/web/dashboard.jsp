<%--
    Document   : dashboard
    Created on : Nov 28, 2020, 2:46:37 PM
    Author     : USER
--%>
...
<!--														<div class="form-button-action">
															<button href="update.jsp?id=<%=id%>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg"  data-original-title="Edit Task">
																<i class="fa fa-edit" ></i>
															</button>
															<button href="delete.jsp?id=<%=id%>" type="button"  data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
