<%-- 
    Document   : newspaper
    Created on : Nov 28, 2020, 6:07:09 PM
    Author     : USER
--%>
...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into newspaper(book_name,author_name,publisher_name,publish_year,description,number_of_page)values(?,?,?,?,?,?)");
                                  ...
                                  Statement st = con.createStatement();
                                   ...
                                   %>
											...
											<tr role="row" class="odd">
													...
													<td>
                                                                                                            <a href="updatenewspaper.jsp?id=<%=id%>">Edit</a>
                                                                                                            <a href="deletenewspaper.jsp?id=<%=id%>">Delete</a>
