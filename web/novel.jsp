<%-- 
    Document   : novell
    Created on : Nov 28, 2020, 6:06:06 PM
    Author     : USER
--%>
...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into novel(book_name,author_name,publisher_name,publish_year,description,number_of_page)values(?,?,?,?,?,?)");
                                  ...
                                  Statement st = con.createStatement();
                                   ...
                                   %>
											...
											<tr role="row" class="odd">
													...
													<td>
                                                                                                            <a href="updatenovel.jsp?id=<%=id%>">Edit</a>
                                                                                                            <a href="deletenovel.jsp?id=<%=id%>">Delete</a>
