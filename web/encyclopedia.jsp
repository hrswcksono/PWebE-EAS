<%-- 
    ...
    Created on : Nov 28, 2020, 6:06:34 PM
    Author     : USER
--%>
...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into encyclopedia(book_name,author_name,publisher_name,publish_year,description,number_of_page)values(?,?,?,?,?,?)");
                     ...
                     <div alight="right">
                         ...
                         <input type="reset" id="reset" value="reset" name="reset" class="btn btn-warning">
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/library","root","");
                                  ...
                                  String query = "select * from encyclopedia";
                                  Statement st = con.createStatement();
                                   ...
                                   %>
											...
											<tr role="row" class="odd">
													...
													<td>
                                                                                                            <a href="updateencyclopedia.jsp?id=<%=id%>">Edit</a>
                                                                                                            <a href="deleteencyclopedia.jsp?id=<%=id%>">Delete</a>
