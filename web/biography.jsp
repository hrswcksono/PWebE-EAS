<%-- 
    Document   : biography
    Created on : Nov 28, 2020, 6:03:05 PM
    Author     : USER
--%>
...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into biography(book_name,author_name,publisher_name,publish_year,description,number_of_page)values(?,?,?,?,?,?)");
                                  ...
                                  Statement st = con.createStatement();
                                   ...
                                   %>
											...
											<tr role="row" class="odd">
													...
													<td>
                                                                                                            <a href="updatebiography.jsp?id=<%=id%>">Edit</a>
                                                                                                            <a href="deletebiography.jsp?id=<%=id%>">Delete</a>
