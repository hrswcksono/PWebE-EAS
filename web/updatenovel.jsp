<%-- 
    Document   : updatenovel
    Created on : Nov 28, 2020, 8:24:03 PM
    Author     : USER
--%>
...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update novel set book_name = ?,author_name =?,publisher_name= ?,publish_year= ?,description= ?,number_of_page= ? where id = ?");
			...
			<div class="content">
				...
				<form  method="POST" action="#" >
                    ...
                    <%    
                        ...
                        pst = con.prepareStatement("select * from novel where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                    ...
                    <% }  %>
                     ...
                     <div alight="right">
                         ...
                         <div align="right">
                             ...
                             <p><a href="novel.jsp">Click Back</a></p>
